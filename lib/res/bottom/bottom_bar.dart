...
class BottomNavBarScreen extends StatelessWidget {
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                _buildBottomNavItem(
                   "assets/amenities/home.png", 'Home', 0, _bottomNavController),
               /* _buildBottomNavItem(
                    Icons.wechat_sharp, 'Chat', 1, _bottomNavController),
                const SizedBox(width: 48), // Space for the FAB*/
                _buildBottomNavItem(
                    "assets/amenities/diskette.png", 'Saved', 1, _bottomNavController),
                _buildBottomNavItem(
                   "assets/amenities/user.png", 'Profile', 2, _bottomNavController),
              ],
            ),
          ),
        ),
  ...
  Widget _buildBottomNavItem(
      String image, String label, int index, BottomNavController controller) {
              ...
              children: [
                Expanded(
                  child: AnimatedScale(
                    ...
                    child: Image.asset(image, color: isSelected
                        ? Colors.white
                        : (isHovered ? Colors.blueGrey : Colors.grey),height: 22,width: 22,)
                  ),
                ),
